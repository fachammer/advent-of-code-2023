...
class Test extends DayTest:
  ...
  "isPossible" - isPossible.testCases(
  ...
  "minimumRequiredCubes" - minimumRequiredCubes.testCases(
    "Game 1" :>
      exampleGames.byId(1).shownCubes ->
      Map("red" -> 4, "green" -> 2, "blue" -> 6),
  )

  "cubeSetPower" - cubeSetPower.testCases(
